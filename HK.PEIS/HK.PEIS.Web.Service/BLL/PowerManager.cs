using HK.PEIS.DTO;
using HK.PEIS.Web.Service.Factory;
...
namespace HK.PEIS.Web.Service.BLL
{
    ...
    public class PowerManager : IPowerManager
    {
        #region Fields
        //创建WCF服务连接对象
        private SR_PowerManager.PowerManageWCFServiceClient oService = CreatePowerManagerService.GetInstance();
        #endregion

        #region 接口实现
        public List<DTO_TB_USERS> GetUsers(Expression<Func<DTO_TB_USERS, bool>> selector = null)
        {
            return oService.GetUsers(GetExpressionNode<DTO_TB_USERS>(selector));
        }

        public List< DTO_TB_DEPARTMENT> GetDepartments(Expression<Func<DTO_TB_DEPARTMENT, bool>> selector = null)
        {
            return oService.GetDepartments(GetExpressionNode<DTO_TB_DEPARTMENT>(selector));
        }

        public List< DTO_TB_ROLE> GetRoles(Expression<Func<DTO_TB_ROLE, bool>> selector = null)
        {
            return oService.GetRoles(GetExpressionNode<DTO_TB_ROLE>(selector));
        }

        public List< DTO_TB_MENU> GetMenus(Expression<Func< DTO_TB_MENU, bool>> selector = null)
        {
